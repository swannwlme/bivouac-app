                  ...
                  children: [
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          mapController.future.then((controller) {
                            controller.getLatLng(ScreenCoordinate(x: MediaQuery.of(context).size.width ~/ 2, y: MediaQuery.of(context).size.height ~/ 2)).then((value) {
                              getAddressFromLocation(value.latitude, value.longitude).then((value) {
                                widget.locationController.text = value;
                              });
                              widget.location = [value.latitude, value.longitude];
                            });
                          });
                          Navigator.pop(context);
                        },
